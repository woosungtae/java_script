			...
			<tr style="background:#33ff00" >
			 ...
			 <tr>       
               <form name="frm_order_all_cart">
					...
					<td><input type="checkbox" name="checked_goods"  checked  value="${item.goods_id }"  onClick="calcGoodsPrice(${item.goods_sales_price*cart_goods_qty},${item.goods_delivery_price},this)"></td>
					...
					<td>
					   <input type="text" id="cart_goods_qty${item.goods_id }" name="cart_goods_qty" size=3 value="${cart_goods_qty}"><br>
	...
	<tbody>
		...
		<tr cellpadding=40  align=center >
	       ...
	       <td>
	         ...
	         <fmt:formatNumber value="${totalDeliveryPrice }" pattern="#,###" /> 원  </p>
	       ...
	       <td>  
	         <p id="p_totalSalesPrice"> 
				        <fmt:formatNumber value="${Math.round(totalDiscountedPrice)}" pattern="#,###" /> 원
	         </p>
